...
(function() {
  'use strict';
  var Posn, actionBox, afterAll, allPlates, allQuestions, background, canvas, contentLoad, ctx, currentScore, cursor, draw, drawCenter, drawImage, font, gameEnd, isCorrect, keysDown, lastKeys, leftKey, leftSlap, leftStop, leftTable, left_answers, left_correct, line, loadAll, loadContent, loadGerman, loadJapanese, loadPlates, loadSpanish, logo, madFace, newPress, plate, question, questionsToAsk, rightKey, rightSlap, rightStop, rightTable, right_answers, right_correct, scoreboard, shuffle, slidingPlates, sushiSensei, sushiSensei2, sushiSensei3, sushiSensei4, sushiSensei5, thisKeys, tintImage, update, winning;
