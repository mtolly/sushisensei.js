...
(function() {
  'use strict';
  var Posn, afterAll, allPlates, allQuestions, background, canvas, colorToRGB, contentLoad, correct, ctx, currentScore, draw, drawCenter, drawImage, gameEnd, hiya, isCorrect, keysDown, lastKeys, leftKey, leftSlap, leftStop, left_answers, left_correct, loadAll, loadContent, loadGerman, loadJapanese, loadPlates, loadSpanish, logo, madFace, newPress, plate, question, questionsToAsk, rightKey, rightSlap, rightStop, right_answers, right_correct, scoreboard, shuffle, slidingPlates, sushiSensei, sushiSensei2, sushiSensei3, sushiSensei4, sushiSensei5, thisKeys, tintImage, update, washing, winning;
  ...
  tintImage = function(img, color) {
    var blue, cached, green, red, tinted, _ref;
    if (color === 'white') {
      return img;
    }
    if (img.tints == null) {
    ...
    _ref = colorToRGB(color), red = _ref[0], green = _ref[1], blue = _ref[2];
