...
(function() {
  'use strict';
  var Posn, allPlates, allQuestions, background, blankWithSize, canvas, copyImage, correct, ctx, currentScore, draw, drawCenter, drawImage, gameEnd, hiya, invert, isCorrect, keysDown, lastKeys, leftKey, leftSlap, leftStop, left_answers, left_correct, loadContent, loadGerman, loadJapanese, loadPlates, loadSpanish, logo, madFace, newPress, plate, question, questionsToAsk, rightKey, rightSlap, rightStop, right_answers, right_correct, scoreboard, shuffle, slidingPlates, sushiSensei, sushiSensei2, sushiSensei3, sushiSensei4, sushiSensei5, thisKeys, tintImage, update, washing, winning;
